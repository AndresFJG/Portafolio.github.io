        ...
        <section className="sobre-mi-seccion" id="sobre-mi">
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id='about-info-1'
                  defaultMessage="Hello, I am Andrés Felipe Jaramillo, independent student; I consider myself a person passionate about programming and web development since in 2022 I had the opportunity to learn about this world of front-end and I was able to create my first web page only using HTML and CSS. From there, I felt a great passion. . for web development, Since this year 2023 I have ventured into the blockchain world since I find it quite interesting and very innovative.."
                />
              </p>
              ...
              <div className="hide parrafo-active">
                <p>
                  <FormattedMessage
                    id='about-info-2'
                    defaultMessage='I consider myself a self-taught person since I like to be constantly learning day by day, both about new technologies and new development methods that help me polish and raise my level of learning, to have a much greater social value and to be able to perform. in different fields of programming.'
                  />
                </p>
                ...
                <p>
                  <FormattedMessage
                    id='about-info-3'
                    defaultMessage="I have experience working as a freelance web designer and developer, which gave me the opportunity to work on many interesting projects, adapting to the client's needs and budget, which allowed me to improve my skills and knowledge; In addition, I have also had the opportunity to participate in some online and in-person courses that helped me enrich my capabilities and learn a little more about this beautiful world of web development. In this last year I have been learning everything related to the backend and programming of smart contracts, since it is a new world and is constantly growing worldwide."
                  />
                </p>
              </div>
          ...
          <div className="skill-seccion">
            ...
            <div className="skill-container">
              ...
              <div className="skill-card" data-aos="flip-right" data-aos-delay="300">
                <img alt="jQuery" className="skills-img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/solidity/solidity-original.svg" title="Solidity"/>
                <h2 className="skill-name">Solidity</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-6'
                    defaultMessage='A year using this programming language to create my smart contracts which I have used in my different Dapps.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-right" data-aos-delay="300">
              ...
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                <img alt="express" className="skills-img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" title="Mysql" />
                <h2 className="skill-name">Mysql</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-10'
                    defaultMessage='More than a year using MySQL to manage my databases.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                <img alt="express" className="skills-img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg"title="Tailwind" />
                <h2 className="skill-name">Tailwind CSS</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-11'
                    defaultMessage='More than a year using the Tailwind CSS framework for the different designs of my web pages.'
                  />
                </p>
              </div>
            </div>

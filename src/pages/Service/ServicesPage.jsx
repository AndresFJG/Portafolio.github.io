        ...
        <div className="row">
            <div className="columns" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3>
                    <FormattedMessage
                        id='design'
                        defaultMessage='Design Dapps'
                    />
                </h3>
                <p>
                    <FormattedMessage
                        id='design-info'
                        defaultMessage='Design of decentralized applications focused on blockchain mainly in Ethereum, seeking an innovative and different environment in the field of programming.'
                    />
                </p>
            </div>
            ...
            <div className="columns" data-aos="fade-up" data-aos-delay="400">
                ...
                <p>
                    <FormattedMessage
                        id='marketing-info'
                        defaultMessage='Production of applications using the Docker tool, for the management and automation of versions on different types of devices'
                    />
                </p>
            </div>

    ...
    return (
        <div>
                ...
                <section className="projects__grid apps">
                    <div className="projects__item">
                        <a onClick={() => cambiarEstadoModal18(!estadoModal18)}>
                            <img src={proyectsImgApp(`./Cinema.png`)} alt="" className="projects__img" />
                        </a>
                    </div>
                    <div className="projects__item">
                        <a onClick={() => cambiarEstadoModal17(!estadoModal17)}>
                            <img src={proyectsImgApp(`./Marketplace.png`)} alt="" className="projects__img" />
                        </a>
                    </div>
                    <div className="projects__item">
                        <a onClick={() => cambiarEstadoModal16(!estadoModal16)}>
                            <img src={proyectsImgApp(`./DappWorks.png`)} alt="" className="projects__img" />
                        </a>
                    </div>
                     <div className="projects__item">
                        <a onClick={() => cambiarEstadoModal15(!estadoModal15)}>
                            <img src={proyectsImgApp(`./loteria2.png`)} alt="" className="projects__img" />
                        </a>
                    </div>
                    {/*<div className="projects__item">
            ...
            >
                <div className="content-modal">
                    <div className="pw-content">
                        <div className="eins-modal-preview"><img src={proyectsImgApp(`./Cinema.png`)} alt="" /></div>
                        <div className="eins-modal-text">
                            ...
                            <p>
                                <FormattedMessage
                                    ...
                                    defaultMessage='A Dapp that offers the cinema service, all using the ethereum blockchain.'
                                />
                            </p>
                            <p>
                                <FormattedMessage
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://cinemaeter.netlify.app" target="_blank">https://cinemaeter.netlify.app</a>
                            </div>
                            <div className="eins-modal-text-3">
                                ...
                                <div className="eins-modal-tec-2">
                                    ...
                                    <img src="https://devicons.railway.app/i/metamask.svg" alt="" />
            ...
            >
                <div className="content-modal">
                    <div className="pw-content">
                        <div className="eins-modal-preview"><img src={proyectsImgApp(`./Marketplace.png`)} alt="" /></div>
                        <div className="eins-modal-text">
                            <p>
                               Marketplace
                            </p>
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://etermarket.netlify.app/" target="_blank">https://etermarket.netlify.app/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
            ...
            >
                <div className="content-modal">
                    <div className="pw-content">
                        <div className="eins-modal-preview"><img src={proyectsImgApp(`./DappWorks.png`)} alt="" /></div>
                        <div className="eins-modal-text">
                            <p>
                              Dapps Work
                            </p>
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://dappsworketer.netlify.app" target="_blank">https://dappsworketer.netlify.app</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
            ...
            >
                <div className="content-modal">
                    <div className="pw-content">
                        <div className="eins-modal-preview"><img src={proyectsImgApp(`./loteria2.png`)} alt="" /></div>
                        <div className="eins-modal-text">
                            <p>
                            EterLotery
                            </p>
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://eterlotery.netlify.app/" target="_blank">https://eterlotery.netlify.app/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage

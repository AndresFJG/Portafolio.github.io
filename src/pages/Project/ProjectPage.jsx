  ...
  return (
    <div>
        ...
        <section className="projects__grid paginas-web">
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal17(!estadoModal17)}>
              <img src={proyectsImg(`./Cafe.png`)} alt="" className="projects__img" />
            </a>
          </div>
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal14(!estadoModal14)}>
              <img src={proyectsImg(`./festival.png`)} alt="" className="projects__img" />
            </a>
          </div>
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal15(!estadoModal15)}>
              <img src={proyectsImg(`./Bienesr.png`)} alt="" className="projects__img" />
            </a>
          </div>
            <div className="projects__item">
            <a onClick={() => cambiarEstadoModal16(!estadoModal16)}>
              <img src={proyectsImg(`./Frontend.png`)} className="projects__img" />
            </a>
          </div> 
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal13(!estadoModal13)}>
              <img src={proyectsImg(`./justice.png`)} alt="" className="projects__img" />
            </a>
            </div>
          {/*<div className="projects__item">
      ...
      >
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview"><img src={proyectsImg(`./Cafe.png`)} alt="" /></div>
            <div className="eins-modal-text">
              <p>
                <FormattedMessage
                  id='projects-info-17-p1'
                  defaultMessage='BlogCafé, page created to provide information about coffee, different courses and everything related to coffee.'
                />
              </p>
              <p>
                <FormattedMessage
                  id='projects-info-17-p2'
                  defaultMessage='Different types of coffee and all the ways you can make delicious coffee.'
                />
              </p>
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://cafeafjg.netlify.app" target="_blank" rel="noreferrer" >https://cafeafjg.netlify.app</a>
              </div>
      ...
      >
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview"><img src={proyectsImg(`./festival.png`)} alt="" /></div>
            <div className="eins-modal-text">
              <p>
                <FormattedMessage
                  id='projects-info-14-p1'
                  defaultMessage='Festival, page created for Rock & EDM Festival.'
                />
              </p>
              <p>
                <FormattedMessage
                  id='projects-info-14-p2'
                  defaultMessage='Focused on advertising a Rock festival for all types of audiences and with its different offers.'
                />
              </p>
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://festivalafjg.netlify.app" target="_blank" rel="noreferrer">https://festivalafjg.netlify.app</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
      ...
      >
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview"><img src={proyectsImg(`./Bienesr.png`)} alt="" /></div>
            <div className="eins-modal-text">
              <p>
                <FormattedMessage
                  id='projects-info-15-p1'
                  defaultMessage='Bienes Raices, is a portfolio for the sale and rental of apartments.'
                />
              </p>
              <p>
                <FormattedMessage
                  id='projects-info-15-p2'
                  defaultMessage='It shows the wide variety of apartments available and their different characteristics, totally affordable and in very good locations.'
                />
              </p>
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://bienesraicesafjg.netlify.app/" target="_blank" rel="noreferrer">https://bienesraicesafjg.netlify.app/</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
      ...
      * <Modal
      ...
      >
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview"><img src={proyectsImg(`./Frontend.png`)} alt="" /></div>
            <div className="eins-modal-text">
              <p>
                <FormattedMessage
                  id='projects-info-16-p1'
                  defaultMessage='Frontend Store, is an online clothing store.'
                />
              </p>
              <p>
                <FormattedMessage
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://tiendaropaafjg.netlify.app" target="_blank" rel="noreferrer">https://tiendaropaafjg.netlify.app</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
      ...
      >
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview"><img src={proyectsImg(`./justice.png`)} alt="" /></div>
            <div className="eins-modal-text">
              <p>
                <FormattedMessage
                  id='projects-info-13-p1'
                  defaultMessage='Justice, page created for a law firm.'
                />
              </p>
              <p>
                <FormattedMessage
                  id='projects-info-13-p2'
                  defaultMessage='Website created to provide information about a law firm, the specialization they have and the different services they provide.'
                />
              </p>
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://justiceeter.netlify.app" target="_blank" rel="noreferrer">https://justiceeter.netlify.app</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/EveryRunning" target="_blank" rel="noreferrer">https://every-running.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/PlusAnime" target="_blank" rel="noreferrer">https://plusanime.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/ElegantHand/" target="_blank" rel="noreferrer">https://elegant-hand.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/vida-en-papel" target="_blank" rel="noreferrer">https://vida-en-papel.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/shop-tec" target="_blank" rel="noreferrer">https://shop-tec.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/Power-Engine" target="_blank" rel="noreferrer">https://power-engine.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/Spider-Man" target="_blank" rel="noreferrer">https://spider-man-fans-page.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/PremierFood" target="_blank" rel="noreferrer">https://premierfood.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span> <a href="https://nahuel61920.github.io/Blog-Coffe" target="_blank" rel="noreferrer">https://ProgramCoffe.com</a>
              </div>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage

        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Andrés Felipe Jaramillo and I am a Full Stack Developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage='I have been dedicated to web development, Dapps and Defi development for 1 year. Every day I seek to improve my knowledge and expand my experience by venturing into different areas of programming.'
                    />
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Soccer and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> andresf.jaramillo2001@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="Typescript" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/solidity/solidity-original.svg" />
                        <h5>Solidity</h5>
                    </div>
                    <div>
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="git" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original-wordmark.svg" title="git" />
                        <h5>Docker</h5>
                    </div>
